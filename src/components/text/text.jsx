...
Text.Heading1 = ({ children, className }) => (
    <h1 className={`text text--headline-1 ${className}`}>{children}</h1>
);

Text.Heading2 = ({ children, className }) => (
    <h2 className={`text text--headline-2 ${className}`}>{children}</h2>
);

Text.Heading3 = ({ children, className }) => (
    <h3 className={`text text--headline-3 ${className}`}>{children}</h3>
);

Text.Heading4 = ({ children, className }) => (
    <h4 className={`text text--headline-4 ${className}`}>{children}</h4>
);
